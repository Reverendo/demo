...
public class BookService {
	...
	private List<Book> books = Arrays.asList(
			...
			new Book("2", "Vampiro: La mariscada",
					"El clásico juego de politiqueo, ahora ambientado en un famoso restaurante junto al congreso."),
			new Book("3", "Criaturas tranquilas y espacios abiertos",
					"Increible juego donde los personajes viajarán por bucolicos paisajes"
